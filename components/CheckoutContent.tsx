...
const paymentOptions: { id: Method; label: string; note: string }[] = [
  { id: 'vodafone_cash', label: 'Vodafone Cash', note: 'Transfer then upload proof' },
  ...(INSTAPAY_ACCOUNT ? [{ id: 'instapay' as const, label: 'InstaPay', note: 'Transfer then upload proof' }] : []),
  { id: 'cash_on_delivery', label: 'Cash on Delivery', note: 'Pay when your order arrives' },
];
