...
export const products: Product[] = [
  ...
  {
    slug: 'tshirt-2', images: ['2.png', '2.png', '2.png', '2.png'], name: 'Tshirt', price: '850 le', collection: 'XLIT original', stockMessage: 'Low stock · selling fast', colors: ['Black', 'Vintage black'], sizes: ['S', 'M', 'L', 'XL'], rating: 4.8, reviewCount: 96,
  ...
  {
    slug: 'tshirt-3', images: ['3.png', '3.png', '3.png', '3.png'], name: 'Tshirt', price: '850 le', collection: 'XLIT original', stockMessage: 'Low stock · selling fast', colors: ['Black', 'Charcoal'], sizes: ['S', 'M', 'L', 'XL'], rating: 4.9, reviewCount: 84,
  ...
  },
  {
    ...
    name: 'Tshirt', price: '850 le', collection: 'XLIT original', stockMessage: 'Low stock · selling fast', colors: ['Off white'],
